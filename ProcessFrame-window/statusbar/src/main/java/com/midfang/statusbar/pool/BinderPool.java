package com.midfang.statusbar.pool;
...
import com.midfang.statusbar.IBinderPool;
import com.midfang.statusbar.StatusBarService;
import com.midfang.statusbar.impl.StatusBarManagerImpl;
import com.midfang.statusbar.impl.StatusBarStatusImpl;
...
public class BinderPool {
    ...
    public static final int BINDER_STATUS = 0;
    public static final int BINDER_MANAGER = 1;
    ...
    private synchronized void connectBinderPoolService() {
        ...
        Intent intent = new Intent(mContext, StatusBarService.class);
